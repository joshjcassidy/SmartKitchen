...
@javax.annotation.Generated(
    ...
    comments = "Source: testphone.proto")
public final class SmartFridgeGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<io.grpc.smartkitchen.testphone.HelloRequest,
      io.grpc.smartkitchen.testphone.HelloResponse> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = io.grpc.smartkitchen.testphone.HelloRequest.class,
      responseType = io.grpc.smartkitchen.testphone.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.grpc.smartkitchen.testphone.HelloRequest,
      io.grpc.smartkitchen.testphone.HelloResponse> getSayHelloMethod() {
    io.grpc.MethodDescriptor<io.grpc.smartkitchen.testphone.HelloRequest, io.grpc.smartkitchen.testphone.HelloResponse> getSayHelloMethod;
    if ((getSayHelloMethod = SmartFridgeGrpc.getSayHelloMethod) == null) {
      synchronized (SmartFridgeGrpc.class) {
        if ((getSayHelloMethod = SmartFridgeGrpc.getSayHelloMethod) == null) {
          SmartFridgeGrpc.getSayHelloMethod = getSayHelloMethod = 
              io.grpc.MethodDescriptor.<io.grpc.smartkitchen.testphone.HelloRequest, io.grpc.smartkitchen.testphone.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "SmartFridge", "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.grpc.smartkitchen.testphone.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.grpc.smartkitchen.testphone.HelloResponse.getDefaultInstance()))
                  .setSchemaDescriptor(new SmartFridgeMethodDescriptorSupplier("SayHello"))
                  .build();
          }
        }
     }
  ...
  public static abstract class SmartFridgeImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sayHello(io.grpc.smartkitchen.testphone.HelloRequest request,
        io.grpc.stub.StreamObserver<io.grpc.smartkitchen.testphone.HelloResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                io.grpc.smartkitchen.testphone.HelloRequest,
                io.grpc.smartkitchen.testphone.HelloResponse>(
  ...
  public static final class SmartFridgeBlockingStub extends io.grpc.stub.AbstractStub<SmartFridgeBlockingStub> {
    ...
    /**
     */
    public io.grpc.smartkitchen.testphone.HelloResponse sayHello(io.grpc.smartkitchen.testphone.HelloRequest request) {
  ...
  public static final class SmartFridgeFutureStub extends io.grpc.stub.AbstractStub<SmartFridgeFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<io.grpc.smartkitchen.testphone.HelloResponse> sayHello(
        io.grpc.smartkitchen.testphone.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((io.grpc.smartkitchen.testphone.HelloRequest) request,
              (io.grpc.stub.StreamObserver<io.grpc.smartkitchen.testphone.HelloResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class SmartFridgeBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return io.grpc.smartkitchen.testphone.Testphone.getDescriptor();
    }
